...
class AnimeBot:
    ...
    async def safe_edit(query, text: str, reply_markup=None, parse_mode=None):
        """Edit message text safely regardless of whether the message contains a photo.
        Photo messages have a 1024-char caption limit; we delete & resend as text instead."""

...
class NyaaScraper:
    ...
    # AnimeTosho API — mirrors nyaa.si without Cloudflare issues
    # q= searches title; we filter 1080 and uploader in post-processing
    ANIMETOSHO_API = "https://feed.animetosho.org/api"
    ANIMETOSHO_SOURCES = {
    ...
    async def _fetch_animetosho(self, source: str, q: str) -> list:
        ...
        Endpoint: https://feed.animetosho.org/api?t=search&q=<query>&limit=100
